...
This project is part of the **BinX Tech AI & ML Internship (Weeks 1–4)**. It applies a complete machine learning workflow to the **Healthcare Stroke Prediction Dataset**, following the curriculum pipeline:
...
8.  Unsupervised Analysis (PCA + K-Means clustering)
...
└── project/
    ...
    ├── Stroke_prediction.ipynb             # Jupyter Notebook (main workflow)
...
-   **Features:** Demographic and clinical attributes (age, gender, hypertension, glucose level, BMI, etc.)
...
-   **Unsupervised Analysis:** PCA + K-Means revealed clusters where older, high-glucose patients had higher stroke rates.
